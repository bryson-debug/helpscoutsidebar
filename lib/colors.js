// Fallback used only if a segment has no `color` from the Flodesk API
// (older segments, or if the field is ever null). Deterministic so the same
// segment always renders the same color across loads/agents.
const PALETTE = [
